...
public class BowcasterItem extends TheStarWarsSagaModModElements.ModElement {
	@ObjectHolder("the_star_wars_saga_mod:bowcaster")
	public static final Item block = null;
	@ObjectHolder("the_star_wars_saga_mod:entitybulletbowcaster")
	public static final EntityType arrow = null;
	public BowcasterItem(TheStarWarsSagaModModElements instance) {
		super(instance, 23);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletbowcaster").setRegistryName("entitybulletbowcaster"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(ItemGroup.COMBAT).maxDamage(120));
			setRegistryName("bowcaster");
		}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("the_star_wars_saga_mod:textures/blast.png");
	...
	public static class Modelcustom_model extends EntityModel<Entity> {
		...
		public Modelcustom_model() {
			...
			bb_main.setTextureOffset(0, 0).addBox(-6.0F, -9.0F, -1.0F, 12.0F, 2.0F, 2.0F, 0.0F, false);
		}
