...
public class Ee11Item extends TheStarWarsSagaModModElements.ModElement {
	@ObjectHolder("the_star_wars_saga_mod:ee_11")
	public static final Item block = null;
	@ObjectHolder("the_star_wars_saga_mod:entitybulletee_11")
	public static final EntityType arrow = null;
	public Ee11Item(TheStarWarsSagaModModElements instance) {
		super(instance, 87);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletee_11").setRegistryName("entitybulletee_11"));
	}
