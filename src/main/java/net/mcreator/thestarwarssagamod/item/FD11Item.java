...
public class FD11Item extends TheStarWarsSagaModModElements.ModElement {
	@ObjectHolder("the_star_wars_saga_mod:fd_11")
	public static final Item block = null;
	@ObjectHolder("the_star_wars_saga_mod:entitybulletfd_11")
	public static final EntityType arrow = null;
	public FD11Item(TheStarWarsSagaModModElements instance) {
		super(instance, 10);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletfd_11").setRegistryName("entitybulletfd_11"));
	}
	...
	public static class ItemRanged extends Item {
		...
		public void onUsingTick(ItemStack itemstack, LivingEntity entityLiving, int count) {
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1.5f, 6, 5);
