...
import net.mcreator.thestarwarssagamod.block.SpiceoreBlock;
...
public class KesselsecuritydroidEntity extends TheStarWarsSagaModModElements.ModElement {
	public static EntityType entity = null;
	public KesselsecuritydroidEntity(TheStarWarsSagaModModElements instance) {
		super(instance, 127);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.8f))
						.build("kesselsecuritydroid").setRegistryName("kesselsecuritydroid");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -8192000, -2228224, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("kesselsecuritydroid_spawn_egg"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("the_star_wars_saga_mod:textures/kesseldroid.png");
				}
			};
	...
	public static class CustomEntity extends TameableEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(6, new BreakBlockGoal(SpiceoreBlock.block.getDefaultState().getBlock(), this, 2e+88, (int) 10));
			...
			this.targetSelector.addGoal(10, new NearestAttackableTargetGoal(this, JarjarbinksEntity.CustomEntity.class, false, false));
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Kessel security droid");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new KesseldroidchestGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
		...
		protected void registerAttributes() {
			...
			this.getAttribute(SharedMonsterAttributes.KNOCKBACK_RESISTANCE).setBaseValue(1.3D);
