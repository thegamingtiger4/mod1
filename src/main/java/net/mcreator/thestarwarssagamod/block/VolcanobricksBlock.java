...
public class VolcanobricksBlock extends TheStarWarsSagaModModElements.ModElement {
	@ObjectHolder("the_star_wars_saga_mod:volcanobricks")
	public static final Block block = null;
	public VolcanobricksBlock(TheStarWarsSagaModModElements instance) {
		super(instance, 195);
	}
