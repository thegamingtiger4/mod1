...
public class Naboo_oakStairsBlock extends TheStarWarsSagaModModElements.ModElement {
	@ObjectHolder("the_star_wars_saga_mod:naboo_oak_stairs")
	public static final Block block = null;
	public Naboo_oakStairsBlock(TheStarWarsSagaModModElements instance) {
		super(instance, 43);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("naboo_oak_stairs");
		}
