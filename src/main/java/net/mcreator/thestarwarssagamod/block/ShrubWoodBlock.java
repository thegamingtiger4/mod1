...
public class ShrubWoodBlock extends TheStarWarsSagaModModElements.ModElement {
	@ObjectHolder("the_star_wars_saga_mod:shrub_wood")
	public static final Block block = null;
	public ShrubWoodBlock(TheStarWarsSagaModModElements instance) {
		super(instance, 65);
	}
