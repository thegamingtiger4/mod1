...
public class BasaltBlock extends TheStarWarsSagaModModElements.ModElement {
	@ObjectHolder("the_star_wars_saga_mod:basalt")
	public static final Block block = null;
	public BasaltBlock(TheStarWarsSagaModModElements instance) {
		super(instance, 104);
	}
