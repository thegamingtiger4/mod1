...
public class KesselsandBlock extends TheStarWarsSagaModModElements.ModElement {
	@ObjectHolder("the_star_wars_saga_mod:kesselsand")
	public static final Block block = null;
	public KesselsandBlock(TheStarWarsSagaModModElements instance) {
		super(instance, 124);
	}
