...
public class ShrubLogBlock extends TheStarWarsSagaModModElements.ModElement {
	@ObjectHolder("the_star_wars_saga_mod:shrub_log")
	public static final Block block = null;
	public ShrubLogBlock(TheStarWarsSagaModModElements instance) {
		super(instance, 66);
	}
