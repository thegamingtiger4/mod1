...
public class FalconturretBlock extends TheStarWarsSagaModModElements.ModElement {
	@ObjectHolder("the_star_wars_saga_mod:falconturret")
	public static final Block block = null;
	public FalconturretBlock(TheStarWarsSagaModModElements instance) {
		super(instance, 97);
	}
