...
public class TinBlockBlock extends TheStarWarsSagaModModElements.ModElement {
	@ObjectHolder("the_star_wars_saga_mod:tin_block")
	public static final Block block = null;
	public TinBlockBlock(TheStarWarsSagaModModElements instance) {
		super(instance, 179);
	}
