...
import net.mcreator.thestarwarssagamod.item.UnrifendtitaniumItem;
...
public class TitaniumOreBlock extends TheStarWarsSagaModModElements.ModElement {
	@ObjectHolder("the_star_wars_saga_mod:titanium_ore")
	public static final Block block = null;
	public TitaniumOreBlock(TheStarWarsSagaModModElements instance) {
		super(instance, 149);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(UnrifendtitaniumItem.block, (int) (1)));
		}
	}
	@Override
