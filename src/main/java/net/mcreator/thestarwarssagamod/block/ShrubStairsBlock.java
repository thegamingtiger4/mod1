...
public class ShrubStairsBlock extends TheStarWarsSagaModModElements.ModElement {
	@ObjectHolder("the_star_wars_saga_mod:shrub_stairs")
	public static final Block block = null;
	public ShrubStairsBlock(TheStarWarsSagaModModElements instance) {
		super(instance, 69);
	}
