...
public class BasaltkyberoreBlock extends TheStarWarsSagaModModElements.ModElement {
	@ObjectHolder("the_star_wars_saga_mod:basaltkyberore")
	public static final Block block = null;
	public BasaltkyberoreBlock(TheStarWarsSagaModModElements instance) {
		super(instance, 109);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("basaltkyberore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BlackkyberItem.block, (int) (1)));
		}
	}
}
