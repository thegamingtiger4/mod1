...
public class TinOreBlock extends TheStarWarsSagaModModElements.ModElement {
	@ObjectHolder("the_star_wars_saga_mod:tin_ore")
	public static final Block block = null;
	public TinOreBlock(TheStarWarsSagaModModElements instance) {
		super(instance, 178);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TinOreBlock.block, (int) (1)));
		}
	}
	@Override
