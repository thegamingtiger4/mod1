...
public class TitaniumBlockBlock extends TheStarWarsSagaModModElements.ModElement {
	@ObjectHolder("the_star_wars_saga_mod:titanium_block")
	public static final Block block = null;
	public TitaniumBlockBlock(TheStarWarsSagaModModElements instance) {
		super(instance, 150);
	}
