...
public class VanadititeBlockBlock extends TheStarWarsSagaModModElements.ModElement {
	@ObjectHolder("the_star_wars_saga_mod:vanaditite_block")
	public static final Block block = null;
	public VanadititeBlockBlock(TheStarWarsSagaModModElements instance) {
		super(instance, 205);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("vanaditite_block");
		}
