...
import net.mcreator.thestarwarssagamod.item.RubidiumIngotItem;
...
public class RubidiumOreBlock extends TheStarWarsSagaModModElements.ModElement {
	@ObjectHolder("the_star_wars_saga_mod:rubidium_ore")
	public static final Block block = null;
	public RubidiumOreBlock(TheStarWarsSagaModModElements instance) {
		super(instance, 211);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RubidiumIngotItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("rubidium_ore", "rubidium_ore", blockAt -> {
