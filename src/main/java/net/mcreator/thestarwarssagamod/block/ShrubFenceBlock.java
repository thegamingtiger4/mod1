...
public class ShrubFenceBlock extends TheStarWarsSagaModModElements.ModElement {
	@ObjectHolder("the_star_wars_saga_mod:shrub_fence")
	public static final Block block = null;
	public ShrubFenceBlock(TheStarWarsSagaModModElements instance) {
		super(instance, 71);
	}
