...
public class EngineBlock extends TheStarWarsSagaModModElements.ModElement {
	@ObjectHolder("the_star_wars_saga_mod:engine")
	public static final Block block = null;
	@ObjectHolder("the_star_wars_saga_mod:engine")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public EngineBlock(TheStarWarsSagaModModElements instance) {
		super(instance, 198);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("engine"));
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("engine");
		}
