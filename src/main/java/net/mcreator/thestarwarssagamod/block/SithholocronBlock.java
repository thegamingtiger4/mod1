...
public class SithholocronBlock extends TheStarWarsSagaModModElements.ModElement {
	@ObjectHolder("the_star_wars_saga_mod:sithholocron")
	public static final Block block = null;
	public SithholocronBlock(TheStarWarsSagaModModElements instance) {
		super(instance, 193);
	}
