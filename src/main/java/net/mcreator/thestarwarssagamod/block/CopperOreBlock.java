...
import net.mcreator.thestarwarssagamod.item.CopperDustItem;
...
public class CopperOreBlock extends TheStarWarsSagaModModElements.ModElement {
	@ObjectHolder("the_star_wars_saga_mod:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(TheStarWarsSagaModModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CopperDustItem.block, (int) (3)));
		}
	}
	@Override
